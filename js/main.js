...
function createCard(item) {
    ...
    `<div class="card">
            ...
            <img src='images/${item.imgUrl}' alt='' class="card__img">
            ...
            <div class="stock">
                ...
                <p class="stock__left"><b>${item.orderInfo.inStock}</b> left in stock</p>
            </div>
            <p class="card__price">Price: <b>${item.price}</b>$</p>
            ...
            <div class="reviews">
                ...
                <div class="review__average">
                    <p class="positive"><b>${item.orderInfo.reviews}%</b> Positive reviews</p>
