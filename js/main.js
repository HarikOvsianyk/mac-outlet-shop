...
items.forEach(function createCard(card) {
        ...
        `<div class="card">
                ...
                <img src='images/${card.imgUrl}' alt='' class="card__img">
                ...
                <div class="stock">
                    ...
                    <p class="stock__left"><b>${card.orderInfo.inStock}</b> left in stock</p>
                </div>
                <p class="card__price">Price: <b>${card.price}</b>$</p>
                ...
                <div class="reviews">
                    ...
                    <div class="review__average">
                        <p class="positive"><b>${card.orderInfo.reviews}%</b> Positive reviews</p>
